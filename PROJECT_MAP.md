...
# آپدیت: 2026-09-19 (فقط ثبت — دروازه‌های انتشار، بدون تغییر کد؛ جزئیات: PLAN.md → «آخرین جلسه») · قبلی: 2026-09-18 (ادامه ۶ — L.1e: نگهبان شناسه‌ی کلمه‌های همراه اپ؛ RTL بسته؛ اصل «یک محتوا، چند ورودی» + A-1 ثبت؛ آفلاین باز)
#
