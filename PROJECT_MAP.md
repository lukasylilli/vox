...
# آپدیت: 2026-09-23 دور ۱۱ (فقط سند، کدی عوض نشد: اتصال Supabase Management API ✅ برقرار؛ PATCH قالب Reset Password ⇒ 400 — قفل free-tier روی API هم هست، نه فقط Studio. قدم بعدی: تصمیم Lukas بین SMTP / Hook / Pro / جریان implicit برای بازیابی — جزئیات PLAN بالا)
#
