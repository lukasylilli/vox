...
- **پیشرفت (2026-09-26 دور ۱۸۰):** آخرین کلمه‌ی ساخته‌شده **eineindeutig** · بعدی **einerlei** · کنار گذاشته: abatisch، abdikativ، afrikaans، aldente، aleppinisch، allenfallsig، altaltbacken، Altdorfer، altkrank، amaranten، ambient، amethysten، amphibolisch، anamorph، anelliert، anotherm، antichretisch، appendikuliert، aretologisch، arschig، arschlos، assi، athermisch، ausheimisch، austral، averbal، azentrisch، azephal، bananig، bannig، basalten، basiklin، basten، batisten، bebuscht، bebust، bedonnert، befotzt، begeißelt، begrannt، behemdet، behost، behuft، beinfarben، bekrallt، bemähnt، bemützt، bepelzt، beredet، berindet، bernsteinen، berstig، berüscht، beschilft، beschürzt، besoffenbesondere، besonderes، besonderer، bestiefelt، bestrumpft، bestusst، betresst، betrieben، bezastert، bezopft، bibliophob، biereifrig، bimaxillär، birken، bitchig، blakig، bland، blaustrümpfig، bonfortionös، botrytisiert، boustrophedon، brennheiß، brillanten، brokaten، buchen، bundrein، buntfarben، busig، bustrophedon، chemometrisch، chilotisch، chionophil، chochem، chondritisch، claviform، damasten، dasig، debitorisch، dekremental، delatorisch، demanten، deprekativ، depretiativ، desiderat، designatus، desmal، dextral، dezisionistisch، diamanten، diffusibel، dikasterial، dilemmatisch، diptotisch، dissidentisch، dissipativ، distich، dolent، doloros، dominicanisch، doppelherzig، drahten، drittelzahlig، dutzend، dyadisch، ebengleich، egressiv، ehrenkäsig، eiben، eichen (فهرست کامل: PLAN.md → «🏁 مرحله‌ی آخر») · آرشیو: ۱۳۹۶ کارت.
