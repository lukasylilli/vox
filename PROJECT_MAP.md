...
- **پیشرفت (2026-09-26 دور ۱۴۴):** آخرین کلمه‌ی ساخته‌شده **bundesdeutsch** · بعدی **bundespolitisch** · کنار گذاشته: abatisch، abdikativ، afrikaans، aldente، aleppinisch، allenfallsig، altaltbacken، Altdorfer، altkrank، amaranten، ambient، amethysten، amphibolisch، anamorph، anelliert، anotherm، antichretisch، appendikuliert، aretologisch، arschig، arschlos، assi، athermisch، ausheimisch، austral، averbal، azentrisch، azephal، bananig، bannig، basalten، basiklin، basten، batisten، bebuscht، bebust، bedonnert، befotzt، begeißelt، begrannt، behemdet، behost، behuft، beinfarben، bekrallt، bemähnt، bemützt، bepelzt، beredet، berindet، bernsteinen، berstig، berüscht، beschilft، beschürzt، besoffenbesondere، besonderes، besonderer، bestiefelt، bestrumpft، bestusst، betresst، betrieben، bezastert، bezopft، bibliophob، biereifrig، bimaxillär، birken، bitchig، blakig، bland، blaustrümpfig، bonfortionös، botrytisiert، boustrophedon، brennheiß، brillanten، brokaten، buchen (فهرست کامل: PLAN.md → «🏁 مرحله‌ی آخر») · آرشیو: ۱۰۳۶ کارت.
