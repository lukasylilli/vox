...
- [ ] **تست RTL همه‌ی صفحات** · **تست آفلاین** — این دو نیاز به باز کردن واقعی اپ در مرورگر (یا حالت
      Airplane) دارند؛ Claude در این محیط مرورگر ندارد ⇒ فقط با Lukas ممکن است (چند دقیقه‌ی ساده: اپ را در
      حالت فارسی باز کند و چند صفحه ببیند + یک‌بار در حالت آفلاین/Airplane تست کند).
