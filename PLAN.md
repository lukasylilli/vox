...
> ⏭️ **قدم بعدی:** (۱) باگ آفلاین — منتظر خروجی DevTools از Lukas (تنها کار بلوکه‌ی L.3) · (۲) درس بعدی
> کتاب / منبع deck بعدی از Lukas · (۳) L.1d تصمیم حذف حساب از Lukas.
...
> Lukas و Claude). فهرست دقیق «هفت مهارت» هنوز از Lukas گرفته نشده.
>
...
3. **هفت مهارت** — مثلاً تمرین‌های کلمه (آرتیکل، معنی، متضاد، املا، تلفظ، …)، حفظیات،
   خواندن، نوشتن و …
   ⚠️ **فهرست دقیق هفت مهارت هنوز با Lukas نهایی نشده** — قبل از پیاده‌سازی باید پرسیده شود.
...
- **Lukas:** تصمیم می‌گیرد کدام شکاف ارزش پرکردن دارد، و فهرست دقیق «هفت مهارت» را می‌دهد.
