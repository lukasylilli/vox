...
>
> 🗓️ **آخرین جلسه:** 2026-09-24 (دور ۴۴) — درخواست Lukas: بخش تازه‌ی **«🏁 مرحله‌ی آخر — کلمه‌هایی که وارد اپ نشده‌اند»** ته PLAN (abatisch، abdikativ + دلیل)؛ قاعده‌ی روال: هر کلمه‌ی کنار گذاشته هم آن‌جا ثبت شود. Lukas روش عددها (numerale) را تأیید کرد.
...
- کارت‌های دیگر آرشیو (افعال Dativ و …) از deckها آمده‌اند، نه از این فهرست‌ها. کل آرشیو: **۲۰۷ کارت** (2026-09-24).
