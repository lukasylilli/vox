...
>
> 🗓️ **آخرین جلسه:** 2026-09-25 (دور ۸۷) — **قواعد آزمون مثل آزمون واقعی ثبت شد** (زمان ⇒ پایان خودکار، نمره‌ی جدای Lesen/Hören/Schreiben/Sprechen، فقط آزمون کامل) — در PLAN (بلوک «✅ قواعد آزمون…») و در قالب نتیجه (`pruefungs_ergebnis.dart`: `zeitLimitSekunden`، `zeitAbgelaufen`، `teileGeordnet`، `vollstaendig`؛ +۳ تست). ⏭️ Claude: T.3 با نمونه‌های ÖSD A1 از Lukas (Hören با Transkript)؛ تا آن موقع G7d و کلمه‌ها.
...
> - ❓ باز: حالت «تمرین» (جواب فوری) — تمرین تک‌بخشی مجاز است یا آن هم فقط کامل؟ (از Lukas پرسیده شد.)
>
