...
>
> 🗓️ **آخرین جلسه:** 2026-09-26 (دور ۱۷۴–۱۸۳) — **۱۰۰ کلمه‌ی تازه** (Lukas: «Weiter»): dunstig … einunddreißigste ⇒ آرشیو **۱۴۲۶ کارت** (هر دور: dry-run ۰/۰، analyze و همه‌ی تست‌ها سبز؛ هر دور commit خودش). **Wortart درست:** einhunderterste، einhundertste، einunddreißigste ⇒ `numerale` (einundzwanzigste هم در `wortartKorrektur` آماده است). **۸ کلمه کنار گذاشته** (⇒ «🏁 مرحله‌ی آخر» #118–125): dutzend، dyadisch، ebengleich، egressiv، ehrenkäsig، eiben، eichen، einschaltbereit. ⏭️ Claude: کلمه‌ها **از einundzwanzigste**.
...
- کارت‌های دیگر آرشیو (افعال Dativ و …) از deckها آمده‌اند، نه از این فهرست‌ها. کل آرشیو: **۱۵۱۶ کارت** (2026-09-26 دور ۱۹۲).
