...
| فاز | وضعیت | خلاصه |
|-----|-------|-------|
| **G — Grammatik Vollausbau** | G1–G6 ✅ · G7a–G7b ✅ / G7c–G8 باز | کاتالوگ ۹۳ موضوع + LektionScreen live (**۸۴ درس**، 2026-09-16)؛ نقشه: `GRAMMATIK_MAP.md` |
...
- [ ] **L.2e تمرین‌ها قبل از انتشار — تصمیم Lukas (2026-09-16).** ترتیب کامل:
      ...
      **G7d** (تمرین برای ردمیتل و deckهای دیگر).
      وضعیت: G7a ✅ · G7b ✅ (2026-09-16) · G7c/G7d باز.
...
- [ ] **G7** تمرین‌ها — **قبل از انتشار** (تصمیم Lukas، L.2e). مراحل:
  ...
  - [x] **G7b** ✅ (2026-09-16، CI سبز روی شاخه + ساخت وب) آزمون ترکیبی هر سطح — منبع: سند «پیکربندی» در `Grammatik`
        ...
        · ⛔ **سؤال از Lukas:** نتیجه («سطح A1 قبول») ذخیره شود؟ اگر بله ⇒ از راه داده‌ی کاربر (فاز S، پشتیبان/همگام‌سازی).
          تا جواب: ذخیره نمی‌شود.
