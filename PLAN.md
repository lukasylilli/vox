...
>
> 🗓️ **آخرین جلسه:** 2026-09-23 (دور ۱۹) — درخواست Lukas ثبت شد: **R-2.3 گسترش همه‌ی محتوای Auswendiglernen بعد از انتشار** (مثال، ترجمه، تمرین و …؛ فقط افزودن، هرگز کم‌کردن). کدی عوض نشد.
...
> - [ ] بازبینی چشمی: ✅ صفحه‌ی پروفایل (فاز P) · ❌ پاپ‌آپ کلمه (L.5f) روی آیفون واقعی باز نمی‌شود — در Chromium/WebKit شبیه‌سازی‌شده باز می‌شود؛ منتظر آزمایش دقیق Lukas (دور ۱۸).
>
