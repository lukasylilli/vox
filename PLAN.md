...
>
> 🗓️ **آخرین جلسه:** 2026-09-23 (دور ۱۵) — **تصمیم Lukas درباره‌ی L.2d:** deckهای بی‌محتوا **پنهان نمی‌شوند**؛ با «به‌زودی» (قفل) می‌مانند و بعد از انتشار پر می‌شوند ⇒ L.2d دیگر شرط انتشار نیست. تأکید دوباره‌ی Lukas: **هیچ به‌روزرسانی بعد از انتشار نباید داده‌ی کاربر را پاک کند** (نگهبان‌های L.1 همین را تضمین می‌کنند). کدی عوض نشد.
