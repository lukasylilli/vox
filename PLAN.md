...
**قدم‌های بعدی (2026-09-15):** ⓪ **فاز S** — ذخیره‌سازی داده‌ی کاربر (S.0a/b/c ✅، S.1 ✅، S.2 ✅، S.3 Schritt 1+2 ✅ · **B-11 ✅ · B-12 ✅ · S.5 ✅ · S.3 ✅ · S.4 ✅** · بعدی: S.6) ① **فاز A** — A.1–A.5 ✅ · **A.6 ⛔ روش ساخت کلمه‌ها: اول از Lukas بپرس** ② **V.2** `vocab.db` — قبل از اینکه تعداد کارت‌ها از چند صد بگذرد، وگرنه startup می‌شکند ③ G3–G6 (استخراج محتوای ۸۴ درس) ④ فاز ۱۶ launch/QA
