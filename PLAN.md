...
>
> 🗓️ **آخرین جلسه:** 2026-09-24 (دور ۴۸) — «🔒 قاعده‌ی ثابت: کلمه‌هایی که وارد اپ نمی‌شوند» در روال ده کلمه ثبت شد (کجا: «🏁 مرحله‌ی آخر» ته PLAN + `zurueckgestellt`؛ کی: بعد از تمام شدن هر چهار فهرست). **ادامه‌ی کلمه‌ها از: agogisch.**
...
- کارت‌های دیگر آرشیو (افعال Dativ و …) از deckها آمده‌اند، نه از این فهرست‌ها. کل آرشیو: **۲۳۶ کارت** (2026-09-24).
