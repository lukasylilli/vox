...
>
> 🗓️ **آخرین جلسه:** 2026-09-19 — فقط مستندسازی: Lukas پرسید آیا ساختار «سطح‌بندی + ترجمه‌ی زیر متن + پاپ‌آپ کلمه + تمرین» برای Lesen/اخبار نوشته شده. **نیمه‌نوشته بود** (L.5b ترجمه، L.5e آزمون، L.5f پاپ‌آپ)؛ سطح A1–C2 برای اخبار، کلمات مهم، نکات گرامری و تقسیم «خودکار / دست‌ساز» نبود ⇒ **L.5g** ثبت شد + دو سؤال باز (منبع سطح اخبار، سرویس ترجمه). کدی تغییر نکرد.
>
...
- [ ] **L.5g ساختار یکسان همه‌ی متن‌های Lesen و اخبار — دو لایه (درخواست Lukas، 2026-09-19).**
      ...
      **۲) لایه‌ی خودکار — برای همه‌ی متن‌ها و اخبار، حتی آنهایی که خودکار به‌روز می‌شوند:**
      ...
      **۳) لایه‌ی دست‌ساز — فقط برای متن‌هایی که از قبل آماده شده‌اند (تعدادشان کمتر است):**
      ...
      **پیاده‌سازی:** لایه‌ی خودکار یک‌بار در کد ساخته شود و همه‌ی متن‌ها از همان استفاده کنند (Component
      ...
      ⛔ **دو سؤال باز — قبل از پیاده‌سازی از Lukas بپرس، حدس نزن:**
